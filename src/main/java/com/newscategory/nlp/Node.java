...
public class Node {
    ...
    int classification;// applicable if leaf, classification = 1 or 2 for class1 and class2
                       // respectively

    public Node(int attr, String value, int c1, int c2, double d, ArrayList<String[]> data,
            ArrayList<Integer> remainingAttributes) {
        attribute = attr;
        noOfClass1 = c1;
        noOfClass2 = c2;
